...
public class ConexionMongoDB {
    ...
    private final String collectionNameCarBuys = "CarritoCompras";
    ...
    public MongoCollection<Document> getCollectionCar() {
        return database.getCollection("CarritoDeComprasPorProducto");
    }
    ...
    public boolean saveCarsBuysTotal(Document doc) {
         try {
            MongoDatabase db = createConnection();
            if (db != null) {
                MongoCollection<Document> collection = db.getCollection(collectionNameCarBuys);
                collection.insertOne(doc);
                return true;
            }
        }catch (Exception e) {
